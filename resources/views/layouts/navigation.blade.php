<nav x-data="{ open: false }" class="glass-effect border-b border-white/20 shadow-lg">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-1 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <a href="{{ route('items.index') }}" class="nav-link inline-flex items-center px-4 py-2 text-sm font-medium rounded-lg transition-all duration-200 {{ request()->routeIs('items.*') ? 'text-blue-600 bg-blue-50' : 'text-gray-700 hover:text-blue-600 hover:bg-blue-50' }}">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6" x-data="{ dropdownOpen: false }">
                <div class="relative">
                    ...
                    <div x-show="dropdownOpen" 
                         ...
                         class="absolute right-0 mt-2 w-56 bg-white/95 backdrop-blur-sm rounded-xl shadow-xl border border-gray-200 py-2 z-50">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-white/95 backdrop-blur-sm border-t border-gray-200">
        <div class="pt-2 pb-3 space-y-1 px-4">
            ...
            <a href="{{ route('items.index') }}" class="block px-3 py-2 rounded-lg text-base font-medium {{ request()->routeIs('items.*') ? 'text-blue-600 bg-blue-50' : 'text-gray-700 hover:text-blue-600 hover:bg-blue-50' }} transition-colors duration-200">
                Items
            </a>
