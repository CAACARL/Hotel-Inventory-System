<div class="bg-white overflow-hidden shadow-sm rounded-xl border border-gray-200 relative">
    <!-- Decorative Background - Large Box/Package Silhouette -->
    <div class="absolute bottom-0 right-[37rem] opacity-5 pointer-events-none">
    ...
    <div class="absolute top-0 right-0 w-40 h-40 bg-gradient-to-bl from-purple-50 to-transparent rounded-full -mr-20 -mt-20"></div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Item Type</th>
