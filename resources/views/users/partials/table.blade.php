        ...
        <div class="flex-1 flex flex-col p-4 min-h-0">
            ...
            <div class="mt-auto flex flex-col space-y-2 pt-2 border-t border-gray-100 flex-shrink-0">
                ...
                <div class="flex space-x-2">
                    ...
                    @if($user->id !== auth()->id())
                    <button @click="deleteUserId = {{ $user->id }}; deleteUserName = '{{ $user->name }}'; deleteModal = true" 
                            class="flex-1 inline-flex items-center justify-center px-2 py-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors duration-200 text-xs font-medium">
                        <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
